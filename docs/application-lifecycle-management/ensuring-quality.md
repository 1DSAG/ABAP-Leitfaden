...
- Überprüfen sie sämtlichen Quellcode der in ihr System eingespielt wird auf sicherheitsrelevante Mängel. Lassen sie sich von SAP Add-On Anbietern Löschtransporte zur Verfügung stellen, bevor die deren Produkte in ihrem System einspielen. Importieren und scannen sie die Transporte von Drittanbietern erstmalig nur in einem Sandbox System,  falls dieser ihnen keinen Löschtransport bereitstellt. **Wenden sie sich vertrauensvoll an den DSAG Arbeitskreis Security, falls der Anbieter sich nicht kooperativ zeigt und ihnen keine Korrektur der Findings, oder ausführliche False-Positiv Beschreibung zur Verfügung stellt.** (#ToDo: Sync. mit Alex.)
{: .highlight}
