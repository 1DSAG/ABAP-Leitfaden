...
- Fixen sie die Ursache des Problems, nicht nur das Symptom: Bei der Entdeckung von Quality Gate Manipulation ist es ratsam zuerst das Gespräch mit dem Entwickler zu suchen und die Ursache zu identifizieren, warum der Entwickler die Quality Gate Manipulation durchgeführt hat. Resultat: Bessere Prozesse ,  Psychologische Sicherheit. ...  
{: .highlight}
