...
Die Objektorientierung ist ein grosses und komplexes Thema, dass sich nicht kurzfristig erschließen lässt, sondern einiges an Erfahrung benötigt um gute objektorientierte Software zu erstellen.  
Für eine effiziente Transformation der Organisation und der Entwickler zu moderner SAP Entwicklung braucht es aber nicht nur die Umsetzung technischer Maßnahmen. Ein Erfolgsfaktor sind gute Rahmenbedingungen und ein Enabling der Entwicklungsteams. Hier spielt die Organisation eine tragende Rolle.
...
Es müssen Instanzen installiert werden, die diese Aspekte definieren, verantworten und auch für die Umsetzung in der täglichen Arbeit sorgen. Dies können Architekturboards, Review-Gremien, zentrale Stellen im Bereich der Entwicklungsorganisation sein, aber auch Personen wie Lead-Developer und Architekten, die nahe an den Entwicklern dran sind. Andernfalls fungieren die o.g. organisatorischen Maßnahmen als "zahnloser Tiger", die Organisationsvorgaben und die reale Arbeit weichen signifikant voneinander ab.  

Die Entwicklungsorganisation muss ich aber auch intensiv darum kümmern, die Entwickler aus- und weiterzubilden, Anreize zu schaffen Neues im Alltag auszuprobieren und anzuwenden und bisherige Vorgehensweisen zu überdenken und anzupassen. Das Interesse und die Motivation der Entwickler für neue Themen ist hierbei ein wichtiger Faktor dafür, dass diese Maßnahmen zu einem erfolgreichen Upskilling der Entwicklungsorganisation führt.  
