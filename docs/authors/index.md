...
<td>Als SAP Solution Manager Libero bin ich seit zehn Jahren auf dem SAP-Spielfeld unterwegs - allerdings nicht in der ABAP-Entwicklung, sondern mit der ALM-Werkzeugkiste in der Hand, um meine Kolleginnen und Kolleginnen mit den Tools des Application Lifecycle Managements wie Prozessmanagement, Testmanagement oder Monitoring zu unterstützen. Das fühlt sich an wie ein Point-and-Click-Adventure, bei dem ich jeden Tag vor neuen Rätseln stehe, die durch logisches Denken, reden mit den anderen Charakteren und Klicken auf dem Bildschirm gelöst werden müssen. SAP ist für mich ein Open-World-Spiel ohne richtiges Ende, das nie langweilig wird, wenn man den nötigen Humor mitbringt.</td>
</tr>
</tbody>
</table>
