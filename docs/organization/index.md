...
Je größer der Anteil an kundenindividueller Anpassung und Erweiterung ihrer vorhandenen SAP Software ist bzw. strategisch werden soll [Kapitel Clean Core](/ABAP-Leitfaden//clean-core/problems-and-challenges/), desto wichtiger ist der unternehmerischer Fokus auf die Effizienz und Effektivität ihrer Entwicklungsorganisation. Der nachfolgende Auszug streift die aus unserer Sicht wichtigsten Themenfelder, die sie auf dem Weg zu einer erfolgreichen Entwicklungsorganisation unterstützen werden. 
...
*   Dokumentation von [angemessener Dokumentation](/ABAP-Leitfaden/documentation/documentation_tipps/) .
