...
| --- |
| Inverse Conway Maneuverhttps://teamtopologies.com/https://flowengineering.org/https://github.com/ddd-crew/core-domain-chartshttps://managingtheunmanageable.net/Lean Software Development – An Agile Toolkit |
...
Unternehmen mit einem geringen Reifegrad in der Softwareentwicklung fahren oft einen ähnlichen Ansatz, mit dem fatalen Unterschied, dass sie ihre Entscheidung zur Aufnahme von technischen Schulden unbewusst treffen und über kurz oder lang im sogenannten [C.R.A.P. Cycle](https://visualstudiomagazine.com/articles/2015/07/01/domain-driven-design.aspx "https://visualstudiomagazine.com/articles/2015/07/01/domain-driven-design.aspx") landen. Häufig wird das Problem durch fehlendes Knowhow im Umgang mit [langlebiger Softwarearchitektur](https://www.informatik-aktuell.de/entwicklung/methoden/langlebige-architekturen-technische-schulden-erkennen-und-beseitigen.html "https://www.informatik-aktuell.de/entwicklung/methoden/langlebige-architekturen-technische-schulden-erkennen-und-beseitigen.html") verstärkt und durch einen rein auf Funktionserweiterung ausgerichteten Change Prozess unter hohem Zeitdruck und geringer Investitionsbereitschaft ad absurdum geführt. Vermeiden Sie diesen Fehler für ein ERP System mit einem Lebenszyklus von 10 - 20 Jahren unbedingt!
...
| Weiterführende Internetquellen und Literaturempfehlung |
| --- |
| https://www.langlebige-softwarearchitekturen.de/https://refactoring.com/https://software-architektur.tv/SAP Application Extension Methodology |
...
*   Innerhalb dieser gibt es zusätzlich verschiedene Level und Reifegrade, an denen entlang sich eine Organisation entwickeln kann. Das [Kanban Maturity Modell](https://www.kanbanmaturitymodel.com/ "https://www.kanbanmaturitymodel.com/") ist hierfür ein Beispiel
